                    ...
                    <form id="order" action="../Controller/orderController.php" method="POST" class="form-horizontal text-info">
                        <div style="color: brown" id="SelectedOrdersContainers">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="room_number" type="number" placeholder="Room" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="text-align:center;color: black">
                            <h3>Total <input id="TotalPrice" style="font-size:23px" class="col-2" type="text" value="0" readonly /> EGP</h3>
                        </div>
